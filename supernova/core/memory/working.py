...
class WorkingMemoryStore:
    ...
    def __init__(self, redis_client: AsyncRedisClient | None = None) -> None:
    ...
    async def get(self, session_id: str) -> WorkingMemory | None:
...
_store_instance: WorkingMemoryStore | None = None
