...
async def deep_health(request: Request, user_id: str = Depends(get_current_user)) -> dict[str, Any]:
    ...
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-ADMIN-OBSERVE-001",
        control_id="CTRL-GW-DEEP-HEALTH-AUDIT",
        user_id=user_id,
        client_host=client_host,
        request_id=request_id,
        actor_type="user",
...
async def prometheus_metrics(request: Request, user_id: str = Depends(get_current_user)) -> Any:
    ...
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-ADMIN-OBSERVE-001",
        control_id="CTRL-GW-METRICS-AUDIT",
        user_id=user_id,
        client_host=client_host,
        request_id=request_id,
        actor_type="user",
    ...
    if not verify_token(token):
        try:
            ...
            _audit_privileged_action(
                ...
                severity="warning",
                policy_id="POL-GW-STREAM-AUTH-001",
                control_id="CTRL-GW-HEALTH-WS-RATE-LIMIT",
                user_id=None,
                client_host=client_host,
                request_id=request_id,
        ...
        _audit_privileged_action(
            ...
            severity="warning",
            policy_id="POL-GW-STREAM-AUTH-001",
            control_id="CTRL-GW-HEALTH-WS-TOKEN-VALIDATION",
            user_id=None,
            client_host=client_host,
            request_id=request_id,
            actor_type="anonymous",
...
async def issue_token(request: Request) -> TokenResponse:
    ...
    if settings.is_production:
        _audit_privileged_action(
            ...
            disposition="blocked",
            severity="warning",
            policy_id="POL-GW-DEMO-AUTH-001",
            control_id="CTRL-GW-DEMO-TOKEN-PRODUCTION-BLOCK",
            user_id=None,
            client_host=client_host,
            request_id=request_id,
            actor_type="anonymous",
    ...
    try:
        ...
        _audit_privileged_action(
            ...
            severity="warning",
            policy_id="POL-GW-DEMO-AUTH-001",
            control_id="CTRL-GW-DEMO-TOKEN-RATE-LIMIT",
            user_id=None,
            client_host=client_host,
            request_id=request_id,
            actor_type="anonymous",
    ...
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-DEMO-AUTH-001",
        control_id="CTRL-GW-DEMO-TOKEN-ISSUANCE",
        user_id=None,
        client_host=client_host,
        request_id=request_id,
        actor_type="anonymous",
    ...
    if not verify_token(token):
        try:
            ...
            _audit_privileged_action(
                ...
                severity="warning",
                policy_id="POL-GW-STREAM-AUTH-001",
                control_id="CTRL-GW-AGENT-STREAM-RATE-LIMIT",
                user_id=None,
                client_host=client_host,
                request_id=request_id,
                actor_type="anonymous",
        ...
        _audit_privileged_action(
            ...
            severity="warning",
            policy_id="POL-GW-STREAM-AUTH-001",
            control_id="CTRL-GW-AGENT-STREAM-TOKEN-VALIDATION",
            user_id=None,
            client_host=client_host,
            request_id=request_id,
            actor_type="anonymous",
...
async def get_semantic_memory(
    ...
    _audit_privileged_action(
        ...
        disposition="observed",
        severity="info",
        policy_id="POL-GW-MEMORY-OBSERVE-001",
        control_id="CTRL-GW-SEMANTIC-MEMORY-READ-AUDIT",
        user_id=user_id,
        client_host=_client_host(request.client),
        request_id=_request_id_from_headers(request.headers),
        actor_type="user",
...
async def get_procedural_skills(request: Request, user_id: str = Depends(get_current_user)) -> list[dict[str, Any]]:
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-MEMORY-OBSERVE-001",
        control_id="CTRL-GW-PROCEDURAL-MEMORY-READ-AUDIT",
        user_id=user_id,
        client_host=_client_host(request.client),
        request_id=_request_id_from_headers(request.headers),
        actor_type="user",
...
async def get_fleet_summary(request: Request, user_id: str = Depends(get_current_user)) -> dict[str, Any]:
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-ADMIN-OBSERVE-001",
        control_id="CTRL-GW-ADMIN-FLEET-AUDIT",
        user_id=user_id,
        client_host=_client_host(request.client),
        request_id=_request_id_from_headers(request.headers),
        actor_type="user",
...
async def get_cost_summary(request: Request, user_id: str = Depends(get_current_user)) -> dict[str, Any]:
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-ADMIN-OBSERVE-001",
        control_id="CTRL-GW-ADMIN-COSTS-AUDIT",
        user_id=user_id,
        client_host=_client_host(request.client),
        request_id=_request_id_from_headers(request.headers),
        actor_type="user",
...
async def get_audit_logs(
    ...
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-ADMIN-OBSERVE-001",
        control_id="CTRL-GW-ADMIN-AUDIT-LOGS-AUDIT",
        user_id=user_id,
        client_host=_client_host(request.client),
        request_id=_request_id_from_headers(request.headers),
        actor_type="user",
...
async def import_memory(
    ...
    _audit_privileged_action(
        ...
        severity="info",
        policy_id="POL-GW-MEMORY-EXPORT-IMPORT-001",
        control_id="CTRL-GW-MEMORY-IMPORT-AUDIT",
        user_id=user_id,
        client_host=_client_host(request.client),
        request_id=_request_id_from_headers(request.headers),
        actor_type="user",
